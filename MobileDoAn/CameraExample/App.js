...
class Scan extends Component {
    ...
    onSuccess = (e) => {
        ...
        alert("http://192.168.43.250:8082/api/checkin?name="+e.data);
        fetch("http://192.168.43.250:8082/api/checkin?name="+e.data , options)
        ...
        return (
            <View style={styles.scrollViewStyle}>
                <Fragment>
                    ...
                    <Text style={styles.textTitle}> ádad Welcome To React-Native QR Code Tutorial !</Text>
                    {!scan && !ScanResult &&
                        <View style={styles.cardView} >
                            ...
                            <TouchableOpacity onPress={this.activeQR} style={styles.buttonTouchable}>
                                <Text style={styles.buttonTextStyle}>Click to Scan ! Hoàng Hiệp</Text>
                            </TouchableOpacity>
                            ...
                            bottomContent={
                                <View>
                                    <TouchableOpacity style={styles.buttonTouchable} onPress={() => this.scanner.reactivate()}>
                                        <Text style={styles.buttonTextStyle}> á OK. Got it!</Text>
                                    </TouchableOpacity>
