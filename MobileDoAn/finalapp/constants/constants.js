...
export const HTTP = {
    ...
    GET_UNCHECK_IMAGE: `${SETTINGS.NODE_SERVER}/api/facial-recognition/unchecks/image/`,
    ...
    DATA_SINGLE_UNCHECK: `${SETTINGS.NODE_SERVER}/api/facial-recognition/unchecks/uncheck/`,
    DATA_ALL_UNCHECK: `${SETTINGS.NODE_SERVER}/api/facial-recognition/unchecks/`, // GET
    DATA_INSERT_PROFILE: `${SETTINGS.NODE_SERVER}/api/facial-recognition/profiles/profile/`, // POST
    DATA_DELETE_PROFILE: `${SETTINGS.NODE_SERVER}/api/facial-recognition/profiles/profile/`, // DELETE
    DATA_EDIT_PROFILE: `${SETTINGS.NODE_SERVER}/api/facial-recognition/profiles/profile/`, // EDIT
